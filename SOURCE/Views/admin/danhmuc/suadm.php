		...
		<div id="content-wrapper">
            ...
            ?>
					<div class="form-group">
                        ...
                        <input type="text" class="form-control" name="TenDM" id="tieude" value="<?php echo $value['TenDM'] ?>">
					  </div>
					  <div class="form-group">
					...
					<button type="submit" name="sua" class="btn btn-default btn-primary">Sửa thông tin danh mục
					</button>
				</form>
				<?php }} ?>
