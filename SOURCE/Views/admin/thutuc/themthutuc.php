                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="TL">
                            <?php foreach ($data1 as $value ) {
												?>
                            <option value="<?php echo $value['idTL'] ?>" selected><?php echo $value['TenTL'] ?></option>
                            <?php }?>
                        </select>
                    </div>
                    <textarea name="NoiDung" class="ckeditor" id="ckeditor"><p>Lĩnh vực:</p>

<p>Tr&igrave;nh tự thực hiện:</p>

<p>C&aacute;ch thức thực hiện:</p>
...
<p>Cơ quan ban h&agrave;nh:</p>

<p>Ủy ban nh&acirc;n d&acirc;n Quận G&ograve; Vấp</p>

<p>Kết quả:</p>

<p>Ph&iacute;, lệ ph&iacute;:</p>

<p>T&ecirc;n mẫu đơn:</p>

<p>Y&ecirc;u cầu, điều kiện thực hiện :</p>

<p>Cơ sở ph&aacute;p l&yacute;:</p>

<p>T&agrave;i liệu đ&iacute;nh k&egrave;m:</p></textarea>
                    <div class="form-group">
